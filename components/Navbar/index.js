...
export default function Navbar() {
  ...
  return (
    <header className='p-4 bg-gradient-to-l to-my-blue from-my-green font-sans fixed w-full'>
      <nav className='flex-col md:flex-row w-full md:inline-flex md:items-center md:justify-between text-white'>
        ...
        <div className={`${isOpen} transition-all duration-300 md:flex h-auto`}>
          ...
          >
            <li className='p-2 z-0 md:px-5 rounded-lg uppercase text-white hover:text-black hover:bg-white duration-300 cursor-pointer'>
              Início
            </li>
            <li className='p-2 z-0 md:px-5 rounded-lg uppercase text-white hover:text-black hover:bg-white duration-300 cursor-pointer'>
              Departamentos
